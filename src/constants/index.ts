...
export const cvObj: CategoryObj[] = [
    {
        ...
        content: [
        {
            ...
            link: 'https://sblum.de',
            description: [
                'PHP- und Javascript-Entwicklung von Webanwendungen und Services auf Basis von Symfony',
                'Single-Page-Anwendungen mit React und implementierung von responsiven User-Interfaces',
